...
In this concept we reviewed Ruby classes, instance methods and variables, and how to pass data from one class into another.

What is still confusing to you about Ruby?
Passing data from one class to another is still a bit confusing, as I've been told that you can't call on another class method within a class. But it turns out that under certain circumstances, you can.

What are you going to study to get more prepared for Phase 1?
I am going to brush up on Ruby classes.
=end